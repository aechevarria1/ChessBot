...
public class ChessTest {
	...
	public void testMoves1() {
		...
		Perft.perftRoot(Chessboard.WP, Chessboard.WN, Chessboard.WB, Chessboard.WR, Chessboard.WQ, Chessboard.WK, Chessboard.BP, Chessboard.BN, Chessboard.BB, Chessboard.BR, Chessboard.BQ, Chessboard.BK, Chessboard.EP, Chessboard.CWK, Chessboard.CWQ, Chessboard.CBK, Chessboard.CBQ, Chessboard.WhiteToMove, 0,false);
	...
	public void testMoves3() {
		String fenString = "8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - -";
		Chessboard.Chessboard(fenString);
